  ...
  return (
    <header
      className={`fixed left-0 right-0 top-0 z-50 transition-all duration-500 ${
        scrolled
          ? "bg-[#071221]/75 backdrop-blur-xl border-b border-cyan-400/10 shadow-[0_10px_40px_rgba(0,0,0,.35)]"
          : "bg-transparent"
      }`}
    >
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 lg:px-8">
        ...
        <Link href="/" className="group flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-2xl border border-cyan-400/30 bg-cyan-400/10 text-cyan-300 font-bold text-lg transition group-hover:scale-105 group-hover:shadow-[0_0_20px_rgba(46,197,255,.45)]">
            S
          </div>
